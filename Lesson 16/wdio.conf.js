...
export const config = {
    ...
    onPrepare: () => {
        ...
        return fs.rm('./reports/tmp/', { recursive: true });
      },
    /**
    ...
    onComplete: () => {
        ...
        generate({
          ...
          // default = '.tmp/json/'
          jsonDir: './reports/tmp/json/',
          reportPath: './reports/tmp/htmlReports',
          pageTitle:'HW on Cucumber - report',
          metadata:{
